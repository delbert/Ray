...
if os.environ[ "AZ_BATCH_IS_CURRENT_NODE_MASTER" ] == "true":
    ...
    os.system( "python ray_cluster_addrs.py --redis_address {} --redis_password='{}'".format( os.environ[ "AZ_BATCH_MASTER_NODE" ] ,
                                                                                                        args.redis_password ) )
else:
    print( "worker node" )
    os.system( "ray start --redis-address={} --redis-password='{}'".format( os.environ[ "AZ_BATCH_MASTER_NODE" ] ,
                                                                                                        args.redis_password ) )